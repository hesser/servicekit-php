...
<body>
    ...
    <div class="container">
      ...
      <div class="row">
		  ...
		  <p><a class="btn btn-primary btn-lg service-request-btn" href="http://76.204.214.224/candy/example/index.html"  onclick="window.open('http://76.204.214.224/candy-1.7.1/candy-1.7.1/example/', 'newwindow', 'width=300, height=250'); return false;"> Chat with us</a></p>
       </div>
	   <div class="col-md-4">
          <h2>Cisco Docs</h2>
          <p></p>
